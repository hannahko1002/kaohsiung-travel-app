...
GEMINI_API_KEY_HARDCODED = "AQ.Ab8RN6JmK_J4clt-Stz6iP7SSVMBchVGL-uy_xpPyN5bat8wuA"
...
def _debug_api_key_status():
    ...
    if has_key:
        ...
        lines.append(
            "請把程式碼最上方 `GEMINI_API_KEY_HARDCODED = \"AQ.Ab8RN6JmK_J4clt-Stz6iP7SSVMBchVGL-uy_xpPyN5bat8wuA\"` "
