...
GEMINI_API_KEY_HARDCODED = "AQ.Ab8RN6JsQ6YNzCQv_itNlwWEu4kn2G5Btuy7OLiYK15GCRvCQA"
...
def _debug_api_key_status():
    ...
    if has_key:
        ...
        lines.append(
            "請把程式碼最上方 `GEMINI_API_KEY_HARDCODED = \"AQ.Ab8RN6JsQ6YNzCQv_itNlwWEu4kn2G5Btuy7OLiYK15GCRvCQA\"` "
