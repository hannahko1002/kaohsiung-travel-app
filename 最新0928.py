...
GEMINI_API_KEY_HARDCODED = "AQ.Ab8RN6I3EzARy1Vwmj6xaF9RdwbeaYxMpt6JAhRuBS1GEuTVKw"
...
def _debug_api_key_status():
    ...
    if has_key:
        ...
        lines.append(
            "請把程式碼最上方 `GEMINI_API_KEY_HARDCODED = \"AQ.Ab8RN6I3EzARy1Vwmj6xaF9RdwbeaYxMpt6JAhRuBS1GEuTVKw\"` "
