...
GEMINI_API_KEY_HARDCODED = "AQ.Ab8RN6Jl2Vr5OM9O2X2s2SNOwTDYpDtPMfy8qiAOMqjMXZKipA"
...
def _debug_api_key_status():
    ...
    if has_key:
        ...
        lines.append(
            "請把程式碼最上方 `GEMINI_API_KEY_HARDCODED = \"AQ.Ab8RN6Jl2Vr5OM9O2X2s2SNOwTDYpDtPMfy8qiAOMqjMXZKipA\"` "
